  ...
  return (
        <Grid templateRows="repeat(6, 1fr)" gap={4} pt="2em"bg="rgba(0,0,0,0)">
              <GridItem m="0em 0em" rounded="lg"  mt="auto" mb="auto" maxW={{smDown: "350px"}}>
                <Card.Root className="dropShadow" size="sm" bg="white"  color="#2B4570" flexDirection="row" overflow="hidden" maxW="3xl" ml="auto" _hover={{ boxShadow: "lg" , transform: "scale(1.02)"}} transition="all 0.3s ease-in-out">
                  <Image
                    hideBelow="md"
                    objectFit="cover"
                    maxW="200px"
                  ...
                  <Box>
                    <Card.Body>
                      ...
                      <Heading  as="h2" pb="2em" size="2xl">Nordea Netbank</Heading>
              ...
              <GridItem m="0em 0em" rounded="lg"  mt="auto" mb="auto" maxW={{smDown: "350px"}} >
                <Card.Root className="dropShadow" bg="#2B4570"  color="white" flexDirection="row" overflow="hidden" maxW="3xl" mr="auto" _hover={{ boxShadow: "lg" , transform: "scale(1.02)"}} transition="all 0.3s ease-in-out">
                  <Image
                    hideBelow="md"
                    objectFit="cover"
                    maxW="200px"
                  ...
                  <Box>
                    <Card.Body>
                      <Heading  as="h2" pb="2em" size="2xl">IKEA Project</Heading>
              ...
              <GridItem m="0em 0em" rounded="lg"  mt="auto" mb="auto" maxW={{smDown: "350px"}}>
                <Card.Root className="dropShadow" bg="white"  color="#2B4570" flexDirection="row" overflow="hidden" maxW="3xl" ml="auto" _hover={{ boxShadow: "lg" , transform: "scale(1.02)"}} transition="all 0.3s ease-in-out">
                  <Image
                    hideBelow="md"
                    objectFit="cover"
                    maxW="200px"
                  ...
                  <Box>
                    <Card.Body>
                      <Heading  as="h2" pb="2em" size="2xl">Smartwatch app and CMS website (personal project)</Heading>
                      <Card.Description  color="#2B4570">
                       ...
                       <Link href="https://web.archive.org/web/20180808002923/http://watchandspin.com/  " target="_blank" p="0em 1em">www.watchandspin.com <FaExternalLinkSquareAlt  /></Link>
                       or if you would like to view a video demonstration of the website and app its here:
                       <Link href="https://www.youtube.com/watch?v=I02Dh1zemuM" target="_blank" p="0em 1em">demo on youtube <FaExternalLinkSquareAlt  /></Link>
                       If you would like to see the code there is a link for the web repository here:
                       <Link href="https://github.com/christengc/www" target="_blank" p="0em 1em">Watchandspin website repository <FaExternalLinkSquareAlt  /></Link>
                       and the app repository here:
                        <Link href="https://github.com/christengc/Watch-IT-android-app" target="_blank" p="0em 1em">Watchandspin android app repository <FaExternalLinkSquareAlt  /></Link>
                      </Card.Description>
                    </Card.Body>
                    <Card.Footer>
                    </Card.Footer>
              ...
              <GridItem m="0em 0em" rounded="lg"  mt="auto" mb="auto" maxW={{smDown: "350px"}}>
                <Card.Root className="dropShadow" bg="cyan.solid"  color="white" flexDirection="row" overflow="hidden" maxW="3xl" mr="auto" _hover={{ boxShadow: "lg" , transform: "scale(1.02)"}} transition="all 0.3s ease-in-out">
                  <Image
                    hideBelow="md"
                    objectFit="cover"
                    maxW="200px"
                  ...
                  <Box>
                    <Card.Body>
                      <Heading  as="h2" pb="2em" size="2xl">Micro Volunteering App (master project)</Heading>
                      <Card.Description  color="white">
