        ...
        <Grid templateRows="repeat(6, 1fr)" gap={4} pt="2em">
                  ...
                  <Box>
                    <Card.Body>
                      ...
                      <Card.Description  color="white">
                        ...
                        My Role was as Defect Mangager (6 months) and Web Developer (18 months). During my time as a web developer I worked mainly on the check out flow where we used vanilla object oriented javascript to write the frontend. The webpage has of course developed since but is still true to the original concept so visit Ikea to get an idea of what I developed.
              ...
              <GridItem m="2em 4em" rounded="lg">
                <Card.Root bg="cyan.solid"  color="white" flexDirection="row" overflow="hidden" maxW="3xl" ml="auto" _hover={{ boxShadow: "lg" , transform: "scale(1.02)"}} transition="all 0.3s ease-in-out">
                  ...
                  <Box>
                    <Card.Body>
                      <Card.Title mb="2">Smartwatch app and CMS website</Card.Title>
                      <Card.Description  color="white">
                       A smartwatch app and a "CMS" site where you can configure your own quiz for your smartwatch. The site is no longer online but can be found on Way back machine here: 
              ...
              <GridItem m="2em 4em" rounded="lg">
                <Card.Root bg="gray.solid"  color="white" flexDirection="row" overflow="hidden" maxW="3xl" mr="auto" _hover={{ boxShadow: "lg" , transform: "scale(1.02)"}} transition="all 0.3s ease-in-out">
                  ...
                  <Box>
                    <Card.Body>
                      <Card.Title mb="2">Micro Volunteering App</Card.Title>
                      <Card.Description  color="white">
                        ...
                        <Link target="_blank" color="white" p="0em 1em" href="https://www2.imm.dtu.dk/pubdb/edoc/imm6558.pdf">Social Media Volunteering
Application<FaExternalLinkSquareAlt/></Link>
                      </Card.Description>
                    </Card.Body>
                    <Card.Footer>
                    </Card.Footer>
