        ...
        <Container>
          ...
          <Heading bg="yellow.solid/50" p="1em" borderColor="gray.300" borderWidth="2px" borderRadius="8px" >
            <Flex alignContent="flex-center" justify="space-around">
              ...
              <Spacer />
              <Box textStyle="4xl"  mt="auto" mb="auto" ml="0.5em"  fontSize={{base: "1em", sm: "1.5em", md: "2.5em" }} fontWeight="100" style={applyFont}>DIGITAL</Box>
              <Box alignContent="flex-end"  mt="auto" mb="auto" ml="0.5em"  fontSize={{base: "1em", sm: "1.5em", md: "2em" }} fontWeight="100" color="#2B4570" style={applyFont2}>Christen</Box>
              <Spacer />
              <Image src="/logo.png" mt="auto" mb="auto" mr={{sm: "0em" , md: "1em"}} width={{base: "2em", sm: "3em" , md: "4em"}} height={{base: "2em", sm: "3em" , md: "4em"}} borderRadius="2em" bg="#2B4570"></Image>
            </Flex>
          </Heading>
